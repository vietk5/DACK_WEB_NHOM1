...
<div class="d-flex align-items-center justify-content-between mb-3">
  ...
  <div class="d-flex gap-2">
    <a class="btn btn-outline-light btn-sm" href="${pageContext.request.contextPath}/admin/revenue">Doanh thu</a>
    <a class="btn btn-outline-light btn-sm" href="${pageContext.request.contextPath}/admin/orders">Đơn hàng</a>
    <a class="btn btn-outline-light btn-sm" href="${pageContext.request.contextPath}/admin/products">Sản phẩm</a>
    <a class="btn btn-outline-light btn-sm" href="${pageContext.request.contextPath}/admin/customers">Khách hàng</a>
    <!-- NÚT NHẬP HÀNG MỚI -->
    <a class="btn btn-rog btn-sm" href="${pageContext.request.contextPath}/receiving">
  ...
  <div class="col-md-6">
    <div class="card border-0 shadow-sm h-100">
      <div class="card-body d-flex flex-column">
        ...
        <div class="row g-2">
          <div class="col-6">
            <a class="btn w-100 btn-outline-light" href="${pageContext.request.contextPath}/admin/products">
              <i class="bi bi-cpu me-1"></i> Quản lý sản phẩm
            </a>
          </div>
          <div class="col-6">
            <a class="btn w-100 btn-outline-light" href="${pageContext.request.contextPath}/admin/orders">
              <i class="bi bi-receipt me-1"></i> Quản lý đơn hàng
            </a>
          </div>
          <div class="col-6">
            <a class="btn w-100 btn-outline-light" href="${pageContext.request.contextPath}/admin/customers">
              <i class="bi bi-people me-1"></i> Quản lý khách hàng
            </a>
          </div>
          <div class="col-6">
            <a class="btn w-100 btn-rog" href="${pageContext.request.contextPath}/receiving">
              <i class="bi bi-box-arrow-in-down me-1"></i> Nhập hàng
            </a>
          </div>
        </div>
            ...
            <tr>
              ...
              <td class="text-end">
                <a class="btn btn-sm btn-outline-light"
                   href="${pageContext.request.contextPath}/receiving?duplicate=true&tenSanPham=${fn:escapeXml(p.tenSanPham)}">
                  +1
                </a>
              </td>
            </tr>
...
<div class="card border-0 shadow-sm mb-3">
  <div class="card-body">
    <div class="d-flex align-items-center justify-content-between">
      ...
      <div class="d-flex gap-2">
        <a class="btn btn-sm btn-outline-light" href="${pageContext.request.contextPath}/admin/orders">Xem tất cả</a>
      </div>
    </div>
      ...
      <table class="table table-dark table-striped align-middle">
        ...
        <tbody>
          <c:forEach var="o" items="${orders}">
            <tr>
              <td>#${o.id}</td>
              <td><fmt:formatDate value="${o.ngayDatHang}" type="both" dateStyle="medium" timeStyle="short"/></td>
              <td><span class="badge text-bg-light border">${o.trangThai}</span></td>
              <td class="text-end">
                <a class="btn btn-sm btn-outline-light" href="${pageContext.request.contextPath}/admin/orders?status=${o.trangThai}">Lọc theo trạng thái</a>
              </td>
            </tr>
          </c:forEach>
