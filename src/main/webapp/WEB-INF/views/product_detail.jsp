          ...
          <div class="card-body">
            <ul class="list-unstyled mb-0">
              <li class="mb-2">
                ...
                <strong>GIAM10</strong> – Giảm 10% cho đơn từ 1.000.000₫
              </li>
              <li class="mb-2">
                <i class="bi bi-ticket-perforated text-warning me-2"></i>
                <strong>FREESHIP</strong> – Miễn phí vận chuyển toàn quốc
              </li>
              <li class="mb-2">
                <i class="bi bi-ticket-perforated text-warning me-2"></i>
                <strong>NEWUSER</strong> – Giảm 50k cho khách hàng mới
              </li>
              <li class="mb-2">
                <i class="bi bi-ticket-perforated text-warning me-2"></i>
                <strong>SALE500K</strong> – Giảm 500k cho đơn từ 10 triệu
              </li>
              <li class="mb-2">
                <i class="bi bi-ticket-perforated text-warning me-2"></i>
                <strong>WEEKEND15</strong> – Giảm 15% vào cuối tuần
              </li>
            </ul>
          </div>
        </div>
